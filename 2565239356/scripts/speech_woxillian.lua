...
return {
	...
	ANNOUNCE_BOOMERANG = "That was as dumb as saying tracing is bad (it isn't)",
	ANNOUNCE_CHARLIE = "I have a feeling like somebody's watching me",
	ANNOUNCE_CHARLIE_ATTACK = "I will bite you back, just wait!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "Goddamn all this fur and still freezing, you must really sucks at the game, huh?",
	ANNOUNCE_HOT = "I'm going to have a f***ing heat stroke.",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing a couple key ingredients.",
	ANNOUNCE_DEERCLOPS = "Come at me bro.",
	ANNOUNCE_CAVEIN = "The world wants revenge upon my existance!",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Finally some good f***ing food.",
		PAINFUL = "Owie.",
		SPOILED = "Reminds me of Atobá's cooking.",
		STALE = "Tastes like",
		INVALID = "Should've fed this to your mom.",
        YUCKY = "I would rather die than consuming this!",
    ...
    {
        "Huff... Pant...",
        "Need to...find someone... to carry this...",
        "Lift... with your back...",
        "Ugh...",
	...
	ANNOUNCE_ENTER_DARK = "Darkness, my old friend.",
	ANNOUNCE_ENTER_LIGHT = "Back to living in the light.",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "Who let the dogs out?!",
	ANNOUNCE_WORMS = "I have a feeling something really bad is about to happen.",
	ANNOUNCE_HUNGRY = "I could eat a good ol' carrot right now",
	...
	ANNOUNCE_INV_FULL = "I don't have infinite storage... yet",
	...
	ANNOUNCE_WORMHOLE = "That was awful.",
	...
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "Goddamnit, shouldn't have lost that bet.",
        MULTIPLAYER_PORTAL_MOONROCK = "But why does it require moon rock?",
        MOONROCKIDOL = "Using sharp moon rocks and that useless gem.",
        CONSTRUCTION_PLANS = "I don't think it's going to work.",
        ...
        WORMWOOD =
        {
            GENERIC = "What's made of wood and is a piece of Playable trash?",
            ATTACKER = "Cope harder, Wormiest.",
            MURDERER = "Prepare to get weed whacked, %s!",
            REVIVER = "Thanks, I wouldn't want to miss the Brazil takeover.",
            GHOST = "Ha! Who's the one that dies everytime now?",
            FIRESTARTER = "Griefing smh my head.",
        },
        WARLY =
        {
            GENERIC = "Greetings, %s!",
